...
**endpoint** | Option<**String**> | Sumologic endpoint URL | [optional]
**host** | Option<**String**> | Sumologic host | [optional][default to use-existing]
...
**sumologic_tags** | Option<**String**> | A comma-separated list of Sumologic tags | [optional][default to use-existing]
