...
------------ | ------------- | ------------- | -------------
**display_id** | Option<**String**> | The display id of the RSA key to use in the signing process | [optional]
**hash_function** | Option<**String**> | HashFunction defines the hash function (e.g. sha-256) | [optional]
**item_id** | Option<**i64**> | The item id of the RSA key to use in the signing process | [optional]
