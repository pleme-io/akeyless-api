...
**audience** | Option<**String**> | The audience in the Kubernetes JWT that the access is restricted to | [optional]
...
**bound_namespaces** | Option<**Vec<String>**> | A list of namespaces that the access is restricted to | [optional]
**bound_pod_names** | Option<**Vec<String>**> | A list of pod names that the access is restricted to | [optional]
**bound_sa_names** | Option<**Vec<String>**> | A list of service account names that the access is restricted to | [optional]
...
**gen_key** | Option<**String**> | Automatically generate key-pair for K8S configuration. If set to false, a public key needs to be provided [true/false] | [optional][default to true]
...
**public_key** | Option<**String**> | Base64-encoded or PEM formatted public key data for K8S authentication method is required [RSA2048] | [optional]
