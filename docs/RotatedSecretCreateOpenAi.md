...
------------ | ------------- | ------------- | -------------
**api_key** | Option<**String**> | Admin API key value to rotate (relevant only for rotator-type=api-key) | [optional]
**api_key_id** | Option<**String**> | Admin API key ID to rotate (relevant only for rotator-type=api-key) | [optional]
