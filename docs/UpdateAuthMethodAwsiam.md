...
**bound_arn** | Option<**Vec<String>**> | A list of full arns that the access is restricted to | [optional]
...
**bound_role_id** | Option<**Vec<String>**> | A list of full role ids that the access is restricted to | [optional]
**bound_role_name** | Option<**Vec<String>**> | A list of full role-name that the access is restricted to | [optional]
...
**sts_url** | Option<**String**> | sts URL | [optional][default to https://sts.amazonaws.com]
