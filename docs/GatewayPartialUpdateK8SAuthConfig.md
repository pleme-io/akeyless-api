...
------------ | ------------- | ------------- | -------------
**use_default_identity_bool** | Option<**bool**> |  | [optional]
**access_id** | Option<**String**> | The access ID of the Kubernetes auth method | [optional]
...
**k8s_host** | Option<**String**> | The URL of the kubernetes API server | [optional]
**k8s_issuer** | Option<**String**> | The Kubernetes JWT issuer name. K8SIssuer is the claim that specifies who issued the Kubernetes token | [optional]
**name** | Option<**String**> | K8S Auth config name | [optional]
**new_name** | Option<**String**> | K8S Auth config new name | [optional]
...
**signing_key** | Option<**String**> | The private key (base64 encoded) associated with the public key defined in the Kubernetes auth | [optional]
**token** | Option<**String**> | Authentication token (see `/auth` and `/configure`) | [optional]
**token_exp** | Option<**i64**> | Time in seconds of expiration of the Akeyless Kube Auth Method token | [optional]
...
**use_gw_service_account** | Option<**String**> | Use the GW's service account | [optional]
