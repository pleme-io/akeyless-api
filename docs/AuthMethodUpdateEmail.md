...
**enable_mfa** | Option<**String**> | Enable MFA for this authentication method [True / False] | [optional]
...
**mfa_type** | Option<**String**> | Enable two-factor-authentication via [email/auth app] | [optional][default to email]
