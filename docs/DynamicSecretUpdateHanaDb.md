...
**hana_dbname** | Option<**String**> | HanaDb Name | [optional]
**hanadb_create_statements** | Option<**String**> | HanaDb Creation statements | [optional]
**hanadb_host** | Option<**String**> | HanaDb Host | [optional][default to 127.0.0.1]
**hanadb_password** | Option<**String**> | HanaDb Password | [optional]
**hanadb_port** | Option<**String**> | HanaDb Port | [optional][default to 443]
**hanadb_revocation_statements** | Option<**String**> | HanaDb Revocation statements | [optional]
**hanadb_username** | Option<**String**> | HanaDb Username | [optional]
