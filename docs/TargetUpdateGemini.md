...
------------ | ------------- | ------------- | -------------
**api_key** | Option<**String**> | API key for Gemini | [optional]
**description** | Option<**String**> | Description of the object | [optional][default to default_comment]
**gemini_url** | Option<**String**> | Base URL of the Gemini API | [optional][default to https://generativelanguage.googleapis.com]
