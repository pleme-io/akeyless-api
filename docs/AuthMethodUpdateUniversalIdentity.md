...
**deny_inheritance** | Option<**bool**> | Deny from root to create children | [optional]
**deny_rotate** | Option<**bool**> | Deny from the token to rotate | [optional]
...
**ttl** | Option<**i32**> | Token ttl | [optional][default to 60]
