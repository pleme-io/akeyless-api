...
**auth_url** | Option<**String**> | sts URL | [optional][default to https://iam.myhwclouds.com:443/v3]
**bound_domain_id** | Option<**Vec<String>**> | A list of domain IDs that the access is restricted to | [optional]
**bound_domain_name** | Option<**Vec<String>**> | A list of domain names that the access is restricted to | [optional]
**bound_ips** | Option<**Vec<String>**> | A CIDR whitelist with the IPs that the access is restricted to | [optional]
**bound_tenant_id** | Option<**Vec<String>**> | A list of full tenant ids that the access is restricted to | [optional]
**bound_tenant_name** | Option<**Vec<String>**> | A list of full tenant names that the access is restricted to | [optional]
**bound_user_id** | Option<**Vec<String>**> | A list of full user ids that the access is restricted to | [optional]
**bound_user_name** | Option<**Vec<String>**> | A list of full user-name that the access is restricted to | [optional]
