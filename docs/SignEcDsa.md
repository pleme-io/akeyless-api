...
**display_id** | Option<**String**> | The display id of the EC key to use for the signing process | [optional]
**item_id** | Option<**i64**> | The item id of the EC key to use for the signing process | [optional]
**json** | Option<**bool**> | Set output format to JSON | [optional][default to false]
**key_name** | Option<**String**> | The name of the EC key to use for the signing process | [optional]
