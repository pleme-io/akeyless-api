...
impl EventForwarderCreateSlack {
    /// eventForwarderCreateSlack is a command that creates slack event forwarder
    pub fn new(gateways_event_source_locations: Vec<String>, name: String, runner_type: String, url: String) -> EventForwarderCreateSlack {
