...
impl TargetCreateGodaddy {
    pub fn new(api_key: String, imap_fqdn: String, imap_password: String, imap_username: String, name: String, secret: String) -> TargetCreateGodaddy {
        TargetCreateGodaddy {
            api_key,
            customer_id: None,
            description: None,
