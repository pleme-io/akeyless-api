...
pub struct GatewayUpdateK8SAuthConfig {
    ...
    #[serde(rename = "cluster-api-type", skip_serializing_if = "Option::is_none")]
...
impl GatewayUpdateK8SAuthConfig {
    /// gatewayUpdateK8SAuth is a command that updates k8s auth config
    pub fn new(access_id: String, k8s_host: String, name: String, new_name: String, signing_key: String) -> GatewayUpdateK8SAuthConfig {
