...
impl EventForwarderCreateServiceNow {
    /// eventForwarderCreateServiceNow is a command that creates service-now event forwarder
    pub fn new(gateways_event_source_locations: Vec<String>, name: String, runner_type: String) -> EventForwarderCreateServiceNow {
