...
impl TargetUpdateGodaddy {
    pub fn new(api_key: String, imap_fqdn: String, imap_password: String, imap_username: String, name: String, secret: String) -> TargetUpdateGodaddy {
        TargetUpdateGodaddy {
            api_key,
            customer_id: None,
            description: None,
