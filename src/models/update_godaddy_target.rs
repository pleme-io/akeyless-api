...
impl UpdateGodaddyTarget {
    /// updateGodaddyTarget is a command that updates an existing target. [Deprecated: Use target-update-godaddy command]
    pub fn new(api_key: String, imap_fqdn: String, imap_password: String, imap_username: String, name: String, secret: String) -> UpdateGodaddyTarget {
        UpdateGodaddyTarget {
            api_key,
            comment: None,
            customer_id: None,
