# Rust API client for akeyless-api
...
Put the package under your project folder in a directory named `akeyless-api` and add the following to `Cargo.toml` under `[dependencies]`:

```
akeyless-api = { path = "./akeyless-api" }
```
